module.exports = function (mongoose) {
  ...
  function isVirtual(model, path) {
    return model.schema.virtuals[path] !== null;
  }
  ...
  function getModelFromPath(db, model, path) {
    ...
    path.split('.').forEach(function (subpath) {
      ...
      var schemaPath = schema.paths[currentPath] || schema.virtuals[currentPath]
      ...
      if (schemaPath.options && schemaPath.options.ref) {
        if(schema.virtuals[schemaPath.path]) {
